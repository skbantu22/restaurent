...
export const sidebarMenu = [
  ...
  // ============================================
  {
    ...
    submenu: [
      ...
      {
        title: "Carriers",
        url: "/admin/shipping/carriers",
      },
      {
        title: "Pickup Points",
        url: "/admin/shipping/pickup",
      },
      {
        title: "Tracking",
        url: "/admin/shipping/tracking",
      },
    ],
  },
  ...
  // ============================================
  {
    ...
    submenu: [
      ...
      {
        title: "Stock Update",
        url: "/admin/showroom/stock-update",
      },
      {
        title: "Stock Transfer",
        url: "/admin/showroom/stock-transfer",
      },
      {
        title: "Confirm Products",
        url: "/admin/showroom/select-products",
      },
      {
        title: "Completed Sales",
        url: "/admin/showroom/sales",
      },
      {
        title: "Showroom Reports",
        url: "/admin/showroom/reports",
      },
    ],
  },
